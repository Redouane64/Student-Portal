...
namespace StudentPortal.WebSite.Data.Migrations
{
    ...
    [Migration("20200514114831_AddForumsDomainModels")]
    partial class AddForumsDomainModels
    {
            ...
            modelBuilder.Entity("Backend6.Models.ForumMessageAttachment", b =>
                {
                    ...
                    b.ToTable("ForumMessageAttachment");
                });
            ...
            modelBuilder.Entity("Backend6.Models.Forum", b =>
                {
                    b.HasOne("Backend6.Models.ForumCategory", "ForumCategory")
                        .WithMany("Forums")
                        .HasForeignKey("ForumCategoryName");
                });
